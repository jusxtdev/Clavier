    ...
    <div className="min-h-screen bg-stone-50 flex items-center justify-center px-6 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          <div className="text-center mb-8">
            <h2 className="text-2xl font-semibold text-stone-900 mb-2">Welcome back</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <Link to="/forgot-password" className="text-sm text-stone-500 hover:text-stone-900 transition-colors">
                  Forgot password?
                </Link>
              </div>
              <input
          ...
          <div className="mt-8 text-center">
            <p className="text-stone-500">
              ...
              <Link to="/signup" className="text-stone-900 font-semibold hover:text-stone-600 transition-colors">
                Sign up
              </Link>
            </p>
          </div>
